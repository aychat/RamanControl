...
if __name__ == '__main__':
    ...
    lower_bounds = np.asarray([0.00020, 3.0, 0.9*energies_A[1], 0.9*energies_A[2], 1.0*energy_factor])
    upper_bounds = np.asarray([0.00070, 10.0, 1.1*energies_A[1], 1.1*energies_A[2], 1.4*energy_factor])

    print(lower_bounds)
    guess = np.asarray([np.random.uniform(lower_bounds[i], upper_bounds[i]) for i in range(len(lower_bounds))])
    guess = np.asarray([0.00108002, 3.37849, 0.00593681, 0.00690409, 0.113151])
    ...
    axes.plot(molecules.time, molecules.field_t.real, 'r')

    fig1, axes = plt.subplots(nrows=2, ncols=2, sharex=True)

    axes[0, 0].plot(molecules.time*time_factor, molecules.dyn_rhoA[0, :], label='11_A', linewidth=2.)
    axes[0, 0].plot(molecules.time*time_factor, molecules.dyn_rhoA[1, :], label='22_A', linewidth=2.)
    axes[0, 0].plot(molecules.time*time_factor, molecules.dyn_rhoA[2, :], label='33_A', linewidth=2.)
    axes[0, 0].plot(molecules.time*time_factor, molecules.dyn_rhoA[3, :], label='44_A', linewidth=2.)
    axes[0, 0].legend(loc=2)
    render_ticks(axes[0, 0])

    axes[0, 1].plot(molecules.time*time_factor, molecules.dyn_rhoB[0, :], label='11_B', linewidth=2.)
    axes[0, 1].plot(molecules.time*time_factor, molecules.dyn_rhoB[1, :], label='22_B', linewidth=2.)
    axes[0, 1].plot(molecules.time*time_factor, molecules.dyn_rhoB[2, :], label='33_B', linewidth=2.)
    axes[0, 1].plot(molecules.time*time_factor, molecules.dyn_rhoB[3, :], label='44_B', linewidth=2.)
    axes[0, 1].legend(loc=2)
    render_ticks(axes[0, 1])

    axes[1, 0].plot(molecules.time*time_factor, molecules.dyn_rhoA[4, :], label='12_A', linewidth=2.)
    axes[1, 0].plot(molecules.time*time_factor, molecules.dyn_rhoA[5, :], label='13_A', linewidth=2.)
    axes[1, 0].plot(molecules.time*time_factor, molecules.dyn_rhoA[6, :], label='14_A', linewidth=2.)
    axes[1, 0].plot(molecules.time*time_factor, molecules.dyn_rhoA[7, :], label='23_A', linewidth=2.)
    axes[1, 0].plot(molecules.time*time_factor, molecules.dyn_rhoA[8, :], label='24_A', linewidth=2.)
    axes[1, 0].plot(molecules.time*time_factor, molecules.dyn_rhoA[9, :], label='34_A', linewidth=2.)
    axes[1, 0].legend(loc=2)
    render_ticks(axes[1, 0])

    axes[1, 1].plot(molecules.time*time_factor, molecules.dyn_rhoB[4, :], label='12_B', linewidth=2.)
    axes[1, 1].plot(molecules.time*time_factor, molecules.dyn_rhoB[5, :], label='13_B', linewidth=2.)
    axes[1, 1].plot(molecules.time*time_factor, molecules.dyn_rhoB[6, :], label='14_B', linewidth=2.)
    axes[1, 1].plot(molecules.time*time_factor, molecules.dyn_rhoB[7, :], label='23_B', linewidth=2.)
    axes[1, 1].plot(molecules.time*time_factor, molecules.dyn_rhoB[8, :], label='24_B', linewidth=2.)
    axes[1, 1].plot(molecules.time*time_factor, molecules.dyn_rhoB[9, :], label='34_B', linewidth=2.)
