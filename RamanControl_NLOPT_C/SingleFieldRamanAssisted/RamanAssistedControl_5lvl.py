...
if __name__ == '__main__':
    ...
    gamma_pure_dephasing[3, 1] = vibrational_dephasing
    gamma_pure_dephasing[1, 3] = vibrational_dephasing
    ...
    guess = np.asarray([0.000349943, 4.0016, energies_A[1], 0.0128597])
