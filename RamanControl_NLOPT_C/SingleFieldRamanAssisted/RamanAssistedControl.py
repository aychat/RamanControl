...
if __name__ == '__main__':
    ...
    lower_bounds = np.asarray([0.00020, 3.0, 0.9*energies_A[1], 1.0*energy_factor])
    upper_bounds = np.asarray([0.00070, 10.0, 1.1*energies_A[1], 1.4*energy_factor])

    print(lower_bounds)
    guess = np.asarray([np.random.uniform(lower_bounds[i], upper_bounds[i]) for i in range(len(lower_bounds))])
    guess = np.asarray([0.0005810, 4.66338, 0.005904, 0.0387406])
